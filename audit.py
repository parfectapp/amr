...
TARGETS = [
    ('audio/amr-marea.m4a', 'MAREA (set v2)'),
    ('audio/amr-marea-cut-marejada.m4a', 'MAREA/MAREJADA'),
    ('audio/amr-marea-cut-coral.m4a', 'MAREA/CORAL'),
    ('audio/amr-001-plinth.m4a', 'PLINTH'),
    ('audio/amr-002-monolith.m4a', 'MONOLITH'),
    ('audio/amr-003-vessel.m4a', 'VESSEL'),
    ('audio/amr-004-strata.m4a', 'STRATA'),
    ('audio/amr-005-ghost.m4a', 'GHOST'),
    ('audio/amr-guer-cut-mezcal.m4a', 'GUERRERO/MEZCAL'),
    ('audio/amr-guer-cut-cactus.m4a', 'GUERRERO/CACTUS'),
    ('audio/amr-guer-cut-fuego.m4a', 'GUERRERO/FUEGO'),
    ('audio/amr-guer-cut-neon.m4a', 'GUERRERO/NEON'),
    ...
    ('set-src/05 - wish you were here remake.mp3', '[REF] wish you were here'),
    ('set-src/10 - Rosablanca.mp3', '[REF] Rosablanca'),
    ('set-src/06 - Aura.mp3', '[REF] Aura'),
    ('set-src/13 - trouble.mp3', '[REF] trouble'),
    ('set-src/90 - Pomona.mp3', '[REF] Pomona'),
]
